...
UBUNTU_TRANSLATION_DOMAIN="match.turan-mahmudov-l"
...
aptest.commands = bash $$PWD/Match/tests/autopilot/run
aptest.depends  = sub-Match

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Match/tests/unit
unittest.depends  = sub-Match
